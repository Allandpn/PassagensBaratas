...
oferta = m.Oferta(preco=780, companhia="Gol", rota="FLN-GRU-SDU", partida="31/10 06:30",
                  chegada="31/10 09:45", paradas=1, destino="RIO")
res = [m.ResultadoDestino(destino="RIO", piso=780, ofertas=[oferta], url="https://x")]
...
print("\nDeep link do Google Flights:")
url = m._monta_query(CFG, "RIO", None).url()
check("url valida", url.startswith("https://www.google.com/travel/flights/search?tfs="), True)
print("      " + url)
